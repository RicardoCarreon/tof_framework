...
from img_utils import show_img, get_img, crop_img, write_img
from file_utils import file_list, change_ext, file_index, write_results, add_tag, \
    get_tag, change_tag, read_file
import numpy as np
import os
from tqdm.auto import tqdm
from parameters import param, get_all_params, set_group_scope
...
def exec_start():
    ...
    print(datetime.strftime(start_time, "%d.%m.%Y - %H:%M:%S") + ' - Processing start (user: \'' + os.getlogin() + '\')')
...
def consolidate(src_file, dst_dir, base_dir, values, cnames=['x','y'], vname='val', nname='name', 
    ...
    import os
    import numpy as np
    from img_utils import write_img
