'''
R. Carreon 03.05.2021 modification V0.1
(solution from https://github.com/pyqtgraph/pyqtgraph/issues/561)

- Added the possibility to apply a different colormap to the multiple roi selection function (img_roi_selector)
lines from 638 to 644 were added and 'flag' colormap is chosen for better visualization of the diferences in the image

- Added the option to change colormap to the show_img funtion, line 243
